...
public class Lunar {
    ...
    protected String getMonthPositionTaiSui(int monthZhiIndex, int monthGanIndex) {
        ...
        p = switch (m) {
            ...
            case 2 -> "坤";
            case 3 -> "巽";
            default -> LunarUtil.POSITION_GAN[monthGanIndex];
        };
        return p;
    }
    ...
    public String getDayPositionTaiSui(int sect) {
        ...
        int yearZhiIndex = switch (sect) {
            case 1 -> {
                ...
                yield this.yearZhiIndex;
            }
            case 3 -> {
                dayInGanZhi = getDayInGanZhi();
                yield this.yearZhiIndexExact;
            }
            default -> {
                dayInGanZhi = getDayInGanZhiExact2();
                yield this.yearZhiIndexByLiChun;
            }
        };
    ...
    public NineStar getYearNineStar(int sect) {
        String yearInGanZhi = switch (sect) {
            case 1 -> this.getYearInGanZhi();
            case 3 -> this.getYearInGanZhiExact();
            default -> this.getYearInGanZhiByLiChun();
        };
    ...
    public NineStar getMonthNineStar(int sect) {
        int yearZhiIndex;
        int monthZhiIndex = switch (sect) {
            case 1 -> {
                yearZhiIndex = this.yearZhiIndex;
                yield this.monthZhiIndex;
            }
            case 3 -> {
                yearZhiIndex = this.yearZhiIndexExact;
                yield this.monthZhiIndexExact;
            }
            default -> {
